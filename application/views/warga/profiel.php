      ...
      <div class="tab-content pt-2">
       <div class="tab-pane fade show active profile-overview" id="profile-overview">
        ...
        <div class="row">
         ...
         <div class="col-lg-9 col-md-8"><?= $profiel['nik'] ?></div>
        </div>
        ...
        <div class="row">
         ...
         <div class="col-lg-9 col-md-8"><?= $profiel['jk'] ?></div>
        </div>
        <div class="row">
        ...
        <div class="row">
         ...
         <div class="col-lg-9 col-md-8"><?= $profiel['agama'] ?></div>
        </div>
        <div class="row">
         <div class="col-lg-3 col-md-4 label ">Pekerjaan</div>
         <div class="col-lg-9 col-md-8"><?= $profiel['pekerjaan'] ?></div>
        </div>
        <div class="row">
        ...
        <div class="row">
         ...
         <div class="col-lg-9 col-md-8"><?= $profiel['rt'] ?></div>
        </div>
        <div class="row">
         <div class="col-lg-3 col-md-4 label ">Status Kawin</div>
         <div class="col-lg-9 col-md-8"><?= $profiel['status_kawin'] ?></div>
        </div>
       </div>
        ...
        <form method="post" enctype="multipart/form-data">
         ...
         <div class="row mb-3">
          ...
          <div class="col-md-8 col-lg-9">
           <input name="nik" type="text" class="form-control" id="fullName" value="<?= $profiel['nik'] ?>" readonly>
         ...
         <div class="row mb-3">
          <label for="fullName" class="col-md-4 col-lg-3 col-form-label">Pekerjaan</label>
          <div class="col-md-8 col-lg-9">
           <input name="pekerjaan" type="text" class="form-control" id="fullName" value="<?= $profiel['pekerjaan'] ?>">
         ...
         <div class="row mb-3">
          <label for="fullName" class="col-md-4 col-lg-3 col-form-label">RT</label>
          <div class="col-md-8 col-lg-9">
           <select class="form-select" aria-label="Default select example" name="rt">
            <?php if ($profiel['rt'] == '01') : ?>
             <option value="01" selected>01</option>
             <option value="02">02</option>
             <option value="03">03</option>
            <?php elseif ($profiel['rt'] == '02') : ?>
         ...
         <div class="row mb-3">
          <label for="fullName" class="col-md-4 col-lg-3 col-form-label">Status Kawin</label>
          <div class="col-md-8 col-lg-9">
           <select class="form-select" aria-label="Default select example" name="status_kawin">
            <?php if ($profiel['status_kawin'] == 'kawin') : ?>
       ...
       <div class="tab-pane fade pt-3" id="profile-change-password">
        <form method="POST" action="<?= base_url('warga/rubahPassword') ?>">
         <div class="row mb-3">
